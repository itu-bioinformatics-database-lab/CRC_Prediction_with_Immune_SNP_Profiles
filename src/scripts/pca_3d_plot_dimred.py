...
data = pd.read_csv('colon_cancer.txt', sep="\t", encoding = "ISO-8859-1")
...
def pca_3dplot_colon(column_num, name, only_cancer=only_cancer, colors=colors, markers=markers):
...
pca_3dplot_colon(13, 'GTE3')
pca_3dplot_colon(14, 'Gn')
pca_3dplot_colon(15, 'GmE')
pca_3dplot_colon(16, 'GESKtumoryeriiii3kolon')
pca_3dplot_colon(17, 'GESKDiferansiyasyon')
pca_3dplot_colon(18, 'ESKperinörinvdegerikolon')